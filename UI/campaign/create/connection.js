(function($) {
    ...
    //   borderclasses empty object
      var tag = options.tag;
    //  tag gives the connection
      var end1 = $(options.from);
      var end2 = $(options.to);
      var within = $(options.within);
      //end1 gives the child  and end2 gives the parent 
    ...
    console.log('border_w : '+border_w);
    console.log('border_h : '+border_h)
